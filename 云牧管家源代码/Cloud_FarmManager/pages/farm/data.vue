	...
	<view class="page-container">
		...
		<view class="content">
				...
				<view class="chart-header">
					...
					<view class="chart-options">
						<view 
							...
							:key="index"
							class="chart-option"
							:class="{ active: activeTimeOption === option }"
							@click="activeTimeOption = option"
						>{{option}}</view>
					</view>
				</view>
				<view class="chart-content">
					<canvas canvas-id="growthChart" id="growthChart" class="chart-canvas"></canvas>
				</view>
				<view class="chart-legend">
					<view class="legend-item">
						<view class="legend-color highlight-color"></view>
						<text>体重</text>
					</view>
					<view class="legend-item">
						<view class="legend-color accent-color"></view>
						<text>饲料消耗</text>
					</view>
				</view>
			</view>
			...
			<view class="chart-container">
				...
				<view class="chart-content">
					<canvas canvas-id="healthChart" id="healthChart" class="chart-canvas"></canvas>
				</view>
				<view class="chart-legend">
					<view class="legend-item">
						<view class="legend-color primary-color"></view>
						<text>活动指数</text>
					</view>
					<view class="legend-item">
						<view class="legend-color dark-color"></view>
						<text>健康评分</text>
					</view>
				</view>
			</view>
					...
					<view class="detail-row" v-for="(item, index) in detailData" :key="index">
						...
						<view class="detail-value-wrapper">
							...
							<text class="rate-badge" v-if="item.rate" :class="{'rate-down': item.rate.includes('-')}">
								<text class="iconfont" :class="item.rate.includes('-') ? 'icon-arrow-down' : 'icon-arrow-up'"></text>
								{{item.rate}}
							</text>
						</view>
					</view>
