...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__3AE14B1",
    appName: "Cloud_FarmManager",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "192.168.201.47,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_MoJLef";
...
const pages = [
  ...
  {
    path: "pages/farm/farm",
    style: {
      navigationBarTitleText: "云养空间"
    }
  },
  {
    path: "pages/farm/game",
    style: {
      navigationBarTitleText: "云养游戏",
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/farm/game2",
    style: {
      navigationBarTitleText: "云养游戏",
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/farm/new",
    style: {
      navigationBarTitleText: "认领新家禽农作物"
    }
  },
  {
    path: "pages/farm/my",
    style: {
      navigationBarTitleText: "我的认领"
    }
  },
  {
    path: "pages/farm/monitor",
    style: {
      navigationBarTitleText: "实时监控"
    }
  },
  {
    path: "pages/farm/data",
    style: {
      navigationBarTitleText: "生长数据分析"
    }
  },
  {
  ...
  {
    path: "pages/shopping/detail/detail",
    style: {
  ...
  {
    path: "pages/shopping/cart/cart",
    style: {
      navigationBarTitleText: "购物车"
    }
  },
  {
    path: "pages/shopping/detail/trace",
    style: {
      navigationBarTitleText: "区块链溯源"
    }
  },
  {
  ...
  {
    path: "pages/shopping/checkout/address",
    style: {
  ...
  {
    path: "pages/test/cart-user-test",
    style: {
      navigationBarTitleText: "购物车用户隔离测试"
    }
  }
];
const globalStyle = {
  ...
  navigationBarTitleText: "云养智旅",
  navigationBarBackgroundColor: "#386641",
  backgroundColor: "#f2e8cf"
};
const tabBar = {
  color: "#7A7E83",
  selectedColor: "#bc4749",
  ...
  list: [
    {
      ...
      selectedIconPath: "/static/tabbar/home（2）.png"
    },
    {
      pagePath: "pages/shopping/shopping",
      text: "购物",
      iconPath: "/static/tabbar/shopping-bag (1).png",
      selectedIconPath: "/static/tabbar/shopping-bag (2).png"
    },
    {
      pagePath: "pages/farm/farm",
      text: "云养",
      iconPath: "/static/tabbar/leaf.png",
      selectedIconPath: "/static/tabbar/leaf(2).png"
    },
    {
      pagePath: "pages/activity/activity",
      text: "活动",
      iconPath: "/static/tabbar/calendar-fill.png",
      selectedIconPath: "/static/tabbar/calendar-fill(2).png"
    },
    {
      pagePath: "pages/profile/profile",
      text: "我的",
      iconPath: "/static/tabbar/user.png",
      selectedIconPath: "/static/tabbar/user（2）.png"
    }
  ]
};
const uniIdRouter = {};
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","192.168.201.47"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/HBuilderX.4.57.2025032507/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"cloud-farm-manager","spaceId":"mp-b07fcee7-ca1e-4931-b02b-8f85379d5658","clientSecret":"JlVuuLop8GbjHRDMPpWh5A==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__3AE14B1";
} catch (e2) {
